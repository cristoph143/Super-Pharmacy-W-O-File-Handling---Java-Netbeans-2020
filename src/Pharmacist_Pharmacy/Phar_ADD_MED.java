 ...
 * @author User
 */
public class Phar_ADD_MED extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("pharmacist add medicine");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(brand_name, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE))))
...
//            ArrayList <Temp_MedList> arrMed = new ArrayList<>(); 
                ...
                JOptionPane.YES_NO_CANCEL_OPTION) == JOptionPane.YES_OPTION)
            {
                ...
                JOptionPane.YES_NO_CANCEL_OPTION) == JOptionPane.YES_OPTION)
                {
                    ...
                    {
                        medTemp[i] = (Temp_MedList) data[i]; 
                        medTemp[i] = new Temp_MedList(genericName,brandName,p,q,Total);
//                        JOptionPane.showMessageDialog(frame,medTemp[i]);
//                        Phar_Inventory[] inventory;
//                        inventory[i] = new Phar_Inventory[i];
//                        inventory[i] = medTemp[i];
                        
                    }
//                    ConfirmMed_Pharmacist conPhar = new ConfirmMed_Pharmacist();
...
//                    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Phar_ADD_MED.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Phar_ADD_MED().setVisible(true);
            }
        });
    }
