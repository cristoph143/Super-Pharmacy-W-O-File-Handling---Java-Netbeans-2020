 ...
 * @author User
 */
public class Admin_ChangePrice extends javax.swing.JFrame {

    
    /**
     * Creates new form register
     */
    public Admin_ChangePrice() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Admin change price");
        ...
        changePrice.setBackground(new java.awt.Color(34, 167, 240));
    ...
    private void changePriceMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_changePriceMouseClicked
        ...
        //        if(generic_name.getText().equals("") || brand_name.getText().equals("") || price.getText().contains("") || quantity.getText().equals(""))
        //        {
            //            JOptionPane.showMessageDialog(frame,"Please Don't leave Empty Spaces!");
            //        }
        //        else
        //        {
            if(JOptionPane.showConfirmDialog(frame,"Add To Medicines?","",
                JOptionPane.YES_NO_CANCEL_OPTION) == JOptionPane.YES_OPTION)
        {
            String [] data = {generic_name.getText(),brand_name.getText(),price.getText(),quantity.getText()};
        ...
        {
            if(JOptionPane.showConfirmDialog(frame,"Continue?","",
                JOptionPane.YES_NO_CANCEL_OPTION) == JOptionPane.YES_OPTION)
        {
            ConfirmMed_Admin conFirm = new ConfirmMed_Admin();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_ChangePrice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_ChangePrice().setVisible(true);
            }
        });
    }
