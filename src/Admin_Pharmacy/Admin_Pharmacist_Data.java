 ...
 * @author User
 */
public class Admin_Pharmacist_Data extends javax.swing.JFrame {

    
    /**
     * Creates new form register
     */
    public Admin_Pharmacist_Data() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Pharmacist_Data.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Pharmacist_Data().setVisible(true);
            }
        });
    }
